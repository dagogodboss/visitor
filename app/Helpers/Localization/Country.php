<?php
/**
 * Vip - iNiLabs visitor management system
 * Copyright (c) inilabs.net All Rights Reserved*
...
class Country
{
	...
	// Maxmind Support URL
	private static $maxmindSupportUrl = 'http://support.inilabs.net/help-center/articles/14/enable-the-geo-location';
