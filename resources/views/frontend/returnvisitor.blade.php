    ...
    <div class="container">
        ...
        <div class="col-md-8 col-sm-12">
                    <div class="card"  style="margin-top:40px;">
                        <div class="card-header" id="Details" align="center"><h4 style="color: #111570;font-weight: bold">Return Visitor</h4></div>
                        <div style="margin: 10px;">
                            {!! Form::open(['url' => '/frontend/visitors/getreturn', 'class' => 'form-horizontal', 'files' => true]) !!}
                         <div class="save">
                             <div class="row">
