                ...
                <div class="row">
                    ...
                    <div class="card"  style="margin-top:40px;">
                        ...
                        <div style="margin: 10px;">
                            ...
                            {!! Form::open(['url' => '/frontend/visitors/store', 'class' => 'form-horizontal', 'files' => true]) !!}
                         <div class="save">
                                <div class="visitor" id="visitor">
                                    @include ('frontend.form', ['formMode' => 'create'])
                                </div>
                                            ...
                                            <div style="float: left">
                                                <div style="float: left">
                                                    ...
                                                    <label class="switch" id="switch">
                                                        <input type="checkbox" name="agreement" id="chekbox">
...
@section('scripts')
    <script>
        ...
        $('#continue2').click(function () {
            ...
            $('#VisitorAgreementtag').append(firstname + ' ' + lastname)
        });
