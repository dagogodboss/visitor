...
<div class="col-md-9">
    <div class="card">
        <div class="card-header">Activity {{ $activitylog->id }}

        <span class="pull-right">
            <a href="{{ url('/admin/activitylogs') }}" title="Back"><button class="btn btn-default btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
            {!! Form::open([
                'method'=>'DELETE',
